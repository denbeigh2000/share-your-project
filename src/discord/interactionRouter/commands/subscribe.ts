...
export const command: RESTPostAPIChatInputApplicationCommandsJSONBody = {
    name: "subscribe",
    description: "Send updates from your Github projects to the channel.",
};
...
export const handler = async (
    ...
    await store.upsertSub(repoObject.id, owningEntity.id, repoObject.default_branch, true);

    // TODO: design embeds etc
    return {
        type: InteractionResponseType.ChannelMessageWithSource,
        data: {
            content: `OK, updates from ${owner}/${repo} will be sent to <#${env.PUBLISH_CHANNEL_ID}>`,
